...
В результате задания у вас должна получиться ссылка на [Google Docs]([https://docs.google.com/document](https://docs.google.com/document/d/1pA6iung7Fbor8H7orYzy4IxGyHPUUFqfWZFJGIzx_ho/edit) или [Яндекс.Документ](https://docs.yandex.ru/) **с оформленным по стандартам, пройденным раньше баг-репортом** и скриншоты Postman.
