...
1. Допустим, вы получили задание протестировать новый лендинг* от Альфа-Банка: https://alfabank.ru/pokraslampas/. (обратите внимание, что форма настоящая, а не тестовая, так что лучше реальные данные им не отправлять) 
