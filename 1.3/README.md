...
Рассмотрим кейсы. Какие методы тест дизайна, изученные на уроке, вы бы применили к каждому из кейсов. Объясните, почему?
...
Результат задания: номер кейса; название метода, которую вы выбрали; пояснение, почему выбрали именно ее.
